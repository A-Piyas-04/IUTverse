...
import PrayerTime from "./view/PrayerTime/PrayerTime.jsx";
import BrainTeaser from "./view/BrainTeaser/BrainTeaser.jsx";
import IUTFacts from "./view/IUTFacts/IUTFacts.jsx";
import Weather from "./view/Weather/Weather.jsx";
import AcademicCalendar from "./view/AcademicCalendar/AcademicCalendar.jsx";
...
export default function HomePage() {
  ...
  return (
    <div className="homepage">
      ...
      {/* Mobile Menu Button */}
      <button 
        className="md:hidden fixed top-20 left-4 z-50 bg-blue-100 hover:bg-blue-200 p-2 rounded-lg shadow-lg transition-colors"
