...
A: A hole`;
  ...
  return (
    <div className="fixed inset-0 bg-[rgba(255, 255, 255, 0.11)] bg-opacity-30 flex items-center justify-center z-50 backdrop-blur-sm animate-fadeIn">
      <div className="bg-gradient-to-br from-white via-purple-50 to-pink-50 rounded-2xl p-8 max-w-lg w-full mx-4 shadow-2xl border border-purple-100 transform transition-all duration-300 scale-100 hover:scale-[1.02] animate-slideUpScale">
        {/* Header */}
        <div className="flex justify-between items-center mb-6 animate-slideDown">
          <h2 className="text-2xl font-bold bg-gradient-to-r from-purple-600 to-pink-600 bg-clip-text text-transparent flex items-center animate-fadeInUp">
        ...
        <div className="mb-8 animate-slideInLeft">
          <div className="bg-gradient-to-r from-pink-100 to-purple-100 border-l-4 border-pink-500 p-6 rounded-xl shadow-md transform transition-all duration-300 hover:shadow-lg hover:scale-[1.02]">
            ...
            <p className="text-gray-700 text-lg leading-relaxed font-medium animate-fadeInUp">{currentQuestion}</p>
          </div>
        </div>
        ...
        {showAnswer && (
          <div className="mb-8 animate-fadeIn">
            <div className="bg-gradient-to-r from-green-100 to-emerald-100 border-l-4 border-green-500 p-6 rounded-xl shadow-md transform transition-all duration-300 hover:shadow-lg hover:scale-[1.02]">
              <h3 className="font-bold text-gray-800 mb-3 flex items-center animate-fadeInUp">
                <span className="mr-2 text-green-500 animate-bounceIn">💡</span>
                Answer:
              </h3>
              <p className="text-gray-700 text-lg leading-relaxed font-medium animate-fadeInUp">{currentAnswer}</p>
            </div>
          </div>
        )}
        ...
        <div className="flex gap-4 animate-slideInRight">
          {!showAnswer ? (
            <button
              ...
              className="flex-1 bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white font-semibold py-3 px-6 rounded-xl transition-all duration-300 transform hover:scale-105 hover:shadow-lg flex items-center justify-center gap-2 animate-fadeInScale"
            >
            ...
            <button
              ...
              className="flex-1 bg-gradient-to-r from-green-500 to-emerald-600 hover:from-green-600 hover:to-emerald-700 text-white font-semibold py-3 px-6 rounded-xl transition-all duration-300 transform hover:scale-105 hover:shadow-lg flex items-center justify-center gap-2 animate-fadeInScale"
            >
